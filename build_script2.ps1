...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const researchPapersData = $jsonText;
    ...
    function renderPapers() {
        ...
        papersGrid.innerHTML = pagePapers.map((paper, index) => {
            const doiBadge = paper.doi ? 
                '<a href="https://doi.org/' + paper.doi + '" target="_blank" rel="noopener" class="paper-doi-btn"><i class="fa-solid fa-link"></i> DOI Link</a>' : '';
...
$jsContent | Out-File -FilePath 'd:\MY PC\Coding\Portfolio\script.js' -Encoding utf8
$jsContent | Out-File -FilePath 'd:\MY PC\Coding\Abdelraouf Ramadan\script.js' -Encoding utf8
Write-Host "Success! script.js built cleanly."

...
document.addEventListener('DOMContentLoaded', () => {
    // --- 117 Research Papers Data Array ---
    ...
    // Fallback safety: hide preloader after max 2.5 seconds no matter what
    ...
    function renderPapers() {
        ...
        // Update count badge
        if (papersCountBadge) {
            papersCountBadge.textContent = "Showing " + filteredPapers.length + " of 117 Papers";
        }
...
Write-Host "Pristine script.js generated!"
